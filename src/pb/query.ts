...
export const StateResponse: MessageFns<StateResponse> = {
  encode(message: StateResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.state !== undefined) {
      GameState.encode(message.state, writer.uint32(10).fork()).join();
    }
    return writer;
  },
...
export const EndGameRequest: MessageFns<EndGameRequest> = {
  encode(message: EndGameRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.whitePlayer !== "") {
      writer.uint32(10).string(message.whitePlayer);
    }
    if (message.blackPlayer !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EndGameRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const EndGameResponse: MessageFns<EndGameResponse> = {
  encode(message: EndGameResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.ok !== false) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EndGameResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const IsInGameRequest: MessageFns<IsInGameRequest> = {
  encode(message: IsInGameRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.player !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): IsInGameRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const IsInGameResponse: MessageFns<IsInGameResponse> = {
  encode(message: IsInGameResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.state !== undefined) {
      GameState.encode(message.state, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): IsInGameResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
